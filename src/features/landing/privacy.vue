    ...
    .container
      .row
        .col-12.public-page-content-wrap
          ...
          p
            | Under the Child’s Online Privacy Security Act, no web site operator can require, as a condition to involvement in an activity, that a child younger than 13 years of age divulge more details than is reasonably required. {{siteName}} abides by this demand. {{siteName}} just collects information willingly offered; no information is gathered passively. children under 13 can submit only their email address when sending us an email in our “Contact Us” area. {{siteName}} makes use of the e-mail address to respond to a one-time demand from a child under 13 and afterwards deletes the e-mail address. In case {{siteName}} collects and maintains personal information relating to a child under 13, the parent may send out an email to us to review, alter and/or erase such info as well as to decline to enable any additional collection or use of the child’s information.
          p
